...
unzip -j -o ../../../${DEVICE}_update.zip lib/modules/disp.ko -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
unzip -j -o ../../../${DEVICE}_update.zip lib/modules/hv2605.ko -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
unzip -j -o ../../../${DEVICE}_update.zip lib/modules/lcd.ko -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
unzip -j -o ../../../${DEVICE}_update.zip lib/modules/sun4i-keyboard.ko -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
...
unzip -j -o ../../../${DEVICE}_update.zip system/lib/modules/hdmi.ko -d ../../../vendor/$MANUFACTURER/$DEVICE/proprietary
